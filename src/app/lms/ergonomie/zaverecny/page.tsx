...
export const metadata: Metadata = {
  title: "Závěrečný test ergonomie práce",
  description: "Oficiální závěrečný test ergonomie práce s certifikátem.",
};

export default async function ErgonomieOfficialTestPage() {
  ...
  const session = await requireOfficialTestAccess(COURSE_SLUG, '/lms/ergonomie/zaverecny');
